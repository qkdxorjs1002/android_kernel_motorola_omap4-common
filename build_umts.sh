...
export LOCALVERSION="-JBX-3.0-Hybrid-UMTS-SPYDER-4.4"
...
while true; do
    ...
    case $yn in
        [Yy]* ) echo "Moving Ramdisk into built path..."; echo " "; cp /data/4.4/out/target/product/umts_spyder/ramdisk.img /home/dtrail/android/built/4.4/3.0/rls/jbx/Applications/ramdisk/; break;;
        [Nn]* ) break;;
        * ) echo "Please answer yes or no.";;
    esac
done
...
echo " "
cp -r /data/4.4/out/target/product/umts_spyder/system/lib/modules/* /home/dtrail/android/built/4.4/3.0/rls/system/lib/modules/
cp /data/4.4/out/target/product/umts_spyder/kernel /home/dtrail/android/built/4.4/3.0/rls/system/etc/kexec/
...
zip -r "JBX-Kernel-3.0-Hybrid-4.4_UMTS_SPYDER_$(date +"%Y-%m-%d").zip" *
mv "JBX-Kernel-3.0-Hybrid-4.4_UMTS_SPYDER_$(date +"%Y-%m-%d").zip" /home/dtrail/android/out
