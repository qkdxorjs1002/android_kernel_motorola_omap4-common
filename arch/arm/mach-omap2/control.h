...
/* #define OMAP44XX_CONTROL_FUSE_MPU_OPP25		0x240 */ /* Added new "virtual" eFuse to get more space for OPPs */
#define OMAP44XX_CONTROL_FUSE_MPU_OPP50		0x243
#define OMAP44XX_CONTROL_FUSE_MPU_OPP100	0x246
/*#define OMAP44XX_CONTROL_FUSE_MPU_OPP100B	0x249 *//* Added fuse for 750 mhz OPP */
#define OMAP44XX_CONTROL_FUSE_MPU_OPPTURBO	0x24B
/*#define OMAP44XX_CONTROL_FUSE_MPU_OPPTURBOB	0x24E *//* Added fuse for 900mhz step */ //FIXME Don't forget to set the right address next time
#define OMAP44XX_CONTROL_FUSE_MPU_OPPNITRO	0x24E
#define OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSB	0x251
#define OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSBA	0x254
#define OMAP44XX_CONTROL_FUSE_CORE_OPP50	0x25C
#define OMAP44XX_CONTROL_FUSE_CORE_OPP100	0x25F
#define OMAP44XX_CONTROL_FUSE_CORE_OPP100OV	0x262
#else
#define OMAP44XX_CONTROL_FUSE_MPU_OPP25		0x240 /* Added new "virtual" eFuse to get more space for OPPs */
#define OMAP44XX_CONTROL_FUSE_MPU_OPP50		0x243
#define OMAP44XX_CONTROL_FUSE_MPU_OPP100	0x246
#define OMAP44XX_CONTROL_FUSE_MPU_OPP100B	0x249 /* Added fuse for 750 mhz OPP */
#define OMAP44XX_CONTROL_FUSE_MPU_OPPTURBO	0x24B
#define OMAP44XX_CONTROL_FUSE_MPU_OPPTURBOB	0x24E /* Added fuse for 900mhz step */
#define OMAP44XX_CONTROL_FUSE_MPU_OPPNITRO	0x251
#define OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSB	0x254
#define OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSBA	0x257
#define OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSBAB	0x25A
#define OMAP44XX_CONTROL_FUSE_CORE_OPP50	0x262
#define OMAP44XX_CONTROL_FUSE_CORE_OPP100	0x265
#define OMAP44XX_CONTROL_FUSE_CORE_OPP100OV	0x268
#endif
