...
#define OMAP4430_VDD_MPU_OPP25_UV		 995000			/* 100 */
#define OMAP4430_VDD_MPU_OPP30_UV		1010000			/* 200 */
#define OMAP4430_VDD_MPU_OPP50_UV		1020000			/* 300 */
#define OMAP4430_VDD_MPU_OPP75_UV		1195000			/* 400 */
#define OMAP4430_VDD_MPU_OPP100_UV		1195000			/* 500 */
#define OMAP4430_VDD_MPU_OPP125_UV		1195000			/* 600 */
#define OMAP4430_VDD_MPU_OPPTURBO_UV		1320000			/* 800 */
#define OMAP4430_VDD_MPU_OPPNITRO_UV		1383000			/* 1000 */
#define OMAP4430_VDD_MPU_OPPNITROSB_UV		1393000			/* 1200 */
#define OMAP4430_VDD_MPU_OPPNITROSBA_UV		1410000			/* 1350 */
#else
...
struct omap_volt_data omap443x_vdd_mpu_volt_data[] = {
	...
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPP30_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPP30, 0, 0, 0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPP50_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPP50, 0, 0, 0xf9, 0x16, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPP75_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPP75, 0, 0, 0xf9, 0x16, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPP100_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPP100, 0, 0, 0xfa, 0x23, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPP125_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPP125, 0, 0, 0xfa, 0x23, OMAP_ABB_NOMINAL_OPP)
...
struct omap_volt_data omap443x_vdd_mpu_volt_data[] = {
	...
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPP30_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPP30, 0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPP50_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPP50, 0xf9, 0x16, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPP75_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPP75, 0xf9, 0x16, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPP100_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPP100, 0xfa, 0x23, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPP125_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPP125, 0xfa, 0x23, OMAP_ABB_NOMINAL_OPP),
...
static struct omap_vdd_dep_volt omap443x_vdd_mpu_core_dep_data[] = {
	...
	{.main_vdd_volt = OMAP4430_VDD_MPU_OPP30_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP50_UV},
	{.main_vdd_volt = OMAP4430_VDD_MPU_OPP50_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP50_UV},
	{.main_vdd_volt = OMAP4430_VDD_MPU_OPP75_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_UV},
...
static struct omap_opp_def __initdata omap443x_opp_def_list[] = {
	...
	/* MPU OPP1 - OPP25 */
 	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 200000000, OMAP4430_VDD_MPU_OPP30_UV),
	/* MPU OPP1 - OPP50 */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 300000000, OMAP4430_VDD_MPU_OPP50_UV),
	/* MPU OPP1 - OPP75 */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 400000000, OMAP4430_VDD_MPU_OPP75_UV),
	/* MPU OPP1 - OPP100 */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 500000000, OMAP4430_VDD_MPU_OPP100_UV),
	/* MPU OPP1 - OPP125 */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 600000000, OMAP4430_VDD_MPU_OPP125_UV),
	/* MPU OPP2 - OPP-TB */
	...
	/* MPU OPP4 - OPP-NTSB1 */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", false, 1350000000, OMAP4430_VDD_MPU_OPPNITROSBA_UV),
#else
	/* MPU OPP1 - OPP25 */
 	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 100000000, OMAP4430_VDD_MPU_OPP25_UV),
	/* MPU OPP1 - OPP50 */
