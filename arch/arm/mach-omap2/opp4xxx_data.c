...
#define OMAP4430_VDD_MPU_OPP25_UV		1000000			/* 100 */
#define OMAP4430_VDD_MPU_OPP50_UV		1015000			/* 250 */
#define OMAP4430_VDD_MPU_OPP100_UV		1085000			/* 400 */
...
struct omap_volt_data omap443x_vdd_mpu_volt_data[] = {
	...
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPP100B_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPP100, 0, 0, 0xf9, 0x16, OMAP_ABB_NOMINAL_OPP),
...
struct omap_volt_data omap443x_vdd_mpu_volt_data[] = {
	...
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPP100B_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPP100, 0xf9, 0x16, OMAP_ABB_NOMINAL_OPP),
...
struct omap_volt_data omap443x_vdd_core_volt_data[] = {
	...
	VOLT_DATA_DEFINE(OMAP4430_VDD_CORE_OPP100A_UV, 10000, OMAP44XX_CONTROL_FUSE_CORE_OPP100A, 0, 0, 0xf9, 0x16, OMAP_ABB_NONE),
	VOLT_DATA_DEFINE(OMAP4430_VDD_CORE_OPP100B_UV, 10000, OMAP44XX_CONTROL_FUSE_CORE_OPP100B, 0, 0, 0xfa, 0x23, OMAP_ABB_NONE),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0, 0, 0),
};
#else
struct omap_volt_data omap443x_vdd_core_volt_data[] = {
	...
	VOLT_DATA_DEFINE(OMAP4430_VDD_CORE_OPP100A_UV, 10000, OMAP44XX_CONTROL_FUSE_CORE_OPP100A, 0xf9, 0x16, OMAP_ABB_NONE),
	VOLT_DATA_DEFINE(OMAP4430_VDD_CORE_OPP100B_UV, 10000, OMAP44XX_CONTROL_FUSE_CORE_OPP100B, 0xfa, 0x23, OMAP_ABB_NONE),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0),
};
#endif
...
static struct omap_opp_def __initdata omap443x_opp_def_list[] = {
	...
	/* MPU OPP1 - OPP50 */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 250000000, OMAP4430_VDD_MPU_OPP50_UV),
	/* MPU OPP1 - OPP50 */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 400000000, OMAP4430_VDD_MPU_OPP100_UV),
	/* MPU OPP1 - OPP100B */
