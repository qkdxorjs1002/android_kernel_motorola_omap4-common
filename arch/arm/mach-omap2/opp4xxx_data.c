...
#define OMAP4430_VDD_MPU_OPP50B_UV		1010000			/* 300 */
#define OMAP4430_VDD_MPU_OPP100_UV		1075000			/* 400 */
#define OMAP4430_VDD_MPU_OPP100B_UV		1190000			/* 600 */
#define OMAP4430_VDD_MPU_OPPTURBO_UV		1315000			/* 800 */
#define OMAP4430_VDD_MPU_OPPNITRO_UV		1378000			/* 1000 */
#define OMAP4430_VDD_MPU_OPPNITROSB_UV		1388000			/* 1200 */
#define OMAP4430_VDD_MPU_OPPNITROSBA_UV		1400000			/* 1350 */
#else
...
struct omap_volt_data omap443x_vdd_mpu_volt_data[] = {
	...
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPP50B_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPP50, 0, 0, 0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP),
...
#define OMAP4430_VDD_CORE_OPP100B_UV		1235000

#ifdef CONFIG_OMAP_SMARTREFLEX_CUSTOM_SENSOR
struct omap_volt_data omap443x_vdd_core_volt_data[] = {
	VOLT_DATA_DEFINE(OMAP4430_VDD_CORE_OPP50_UV, 0, 0, 0, 0, 0, 0, 0, 0xf4, 0x0c, OMAP_ABB_NONE),
...
#else
struct omap_volt_data omap443x_vdd_core_volt_data[] = {
	VOLT_DATA_DEFINE(OMAP4430_VDD_CORE_OPP50_UV, 0, 0, 0xf4, 0x0c, OMAP_ABB_NONE),
...
static struct omap_opp_def __initdata omap443x_opp_def_list[] = {
	...
	/* MPU OPP1 - OPP50 */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 300000000, OMAP4430_VDD_MPU_OPP50B_UV),
	/* MPU OPP1 - OPP100 */
