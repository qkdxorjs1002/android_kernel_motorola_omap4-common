...
CFLAGS_MODULE   = -DMODULE -O2 -mcpu=cortex-a9 -mfpu=neon -ftree-vectorize -fno-pic 
AFLAGS_MODULE   = -mcpu=cortex-a9 -mfpu=neon -ftree-vectorize 
LDFLAGS_MODULE  =
CFLAGS_KERNEL	= -mcpu=cortex-a9 -mfpu=neon -ftree-vectorize 
AFLAGS_KERNEL	= -mcpu=cortex-a9 -mfpu=neon -ftree-vectorize 
