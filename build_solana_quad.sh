...
make -j8 TARGET_KERNEL_SOURCE=/home/dtrail/android/android_kernel_motorola_omap4-common/ TARGET_KERNEL_CONFIG=mapphone_OCE_defconfig $OUT/boot.img

# We don't use the kernel but the modules
echo "Copying modules to package folder"
echo " "
cp -r /home/dtrail/android/4.4/out/target/product/spyder/system/lib/modules/* /home/dtrail/android/built/4.4/solana/rls/system/lib/modules/
cp /home/dtrail/android/4.4/out/target/product/spyder/kernel /home/dtrail/android/built/4.4/solana/rls/system/etc/kexec/
...
cd /home/dtrail/android/built/4.4/solana/rls
zip -r "JBX-Kernel-3.0-Hybrid-4.4_$(date +"%Y-%m-%d").zip" *
mv "JBX-Kernel-3.0-Hybrid-4.4_$(date +"%Y-%m-%d").zip" /home/dtrail/android/out
