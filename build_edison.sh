...
echo " "
export LOCALVERSION="-JBX-1.2-Hybrid-Edison-4.3"
...
zip -r "JBX-Kernel-1.2-Hybrid-Edison-4.3_$(date +"%Y-%m-%d").zip" *
mv "JBX-Kernel-1.2-Hybrid-Edison-4.3_$(date +"%Y-%m-%d").zip" /home/dtrail/android/out
