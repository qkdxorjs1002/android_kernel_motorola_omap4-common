...
export LOCALVERSION="-JBX-0.7d-Hybrid-Nightly"
...
zip -r "JBX-Kernel-0.7d-Hybrid-Nightly_$(date +"%Y-%m-%d").zip" *
mv "JBX-Kernel-0.7d-Hybrid-Nightly_$(date +"%Y-%m-%d").zip" /home/mnl-manz/razr_kdev_kernel/built
